...
When deploying a new instance in Cypherium Ropsten, you need to modify the address in the following files:
...
```sh
git clone https://github.com/cypherium/uniswap-sdk-cypherium.git
```

Move into the uniswap-sdk working directory

```sh
cd uniswap-sdk-cypherium/
```
